...
![数据并行与模型并行示意图](./3.大语言模型基础知识/megatron1.png)

![流水线并行和张量并行示意图](./3.大语言模型基础知识/megatron2.png)
...
- DPO 实现方式
  	![dpo pipeline](./3.大语言模型基础知识/dpo.png)
...
![chatglm2](./3.大语言模型基础知识/chatglm2.png)
	...
	![chatglm2 multiturn](./3.大语言模型基础知识/chatglm2.png)
